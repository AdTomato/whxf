...
public class DingDingUtil {
     ...
     * @return
     */
    public static OapiProcessinstanceListidsResponse   getApprovalIds(String userIds){
        DingTalkClient client = new DefaultDingTalkClient("https://oapi.dingtalk.com/topapi/processinstance/listids");
        OapiProcessinstanceListidsRequest req = new OapiProcessinstanceListidsRequest();
        req.setProcessCode(PROCESSCODEBYSLCC);//商旅出差
        Date[] dates=DateUtil.getWeek();
        req.setStartTime(dates[0].getTime());
        req.setEndTime(System.currentTimeMillis());
        req.setSize(20L);//分页参数，每页大小，最多传20，默认值：20
        req.setCursor(0L);
     ...
     * @return
     */
    public static OapiProcessinstanceGetResponse   getApprovalDetail(String processId){
